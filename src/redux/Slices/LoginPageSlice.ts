...
export const loginSlice = createSlice({
   ...
   reducers: {
      ...
      mouseMove: (state, action) => {
         state.mousePos = { x: action.payload.x / window.innerWidth, y: action.payload.y / window.innerHeight };
         console.log(action.payload);
      },
   },
});

export const { changeLogin, changeLoginText, changePasswordText, changePasswordConfirmValue, loginBtnClick, mouseMove, registrationBtnClick } =
   loginSlice.actions;
